    ...
    <div class="row">
        ...
        <table class = "table table-striped" style="text-align: center; padding-top: 40px; border: 1px solid #dddddd">
            ...
            <%
                ...
                ArrayList<LendDto> list = libraryDao.allLendInfo(pageNumber);
        ...
        <div>
            <ul class="pagination justify-content-center mt-3">
                <li class="page-item">
                    ...
                    %>
                    <a class="page-link"
                       href="./managerUserLendList?pageNumber=<%=pageNumber-1%>">이전</a>
                    <%
                        }
                    %>
                </li>
                <li class="page-item">
                    ...
                    %>
                    <a class="page-link"
                       href="./managerUserLendList?pageNumber=<%=pageNumber+1%>">다음</a>
                    <%
                        }
                    %>
                </li>
